...
from core.blocks.blocks import BlockManager
from core.blocks.types import BlockType, JointType
from core.analyzer import NetworkAnalyzer, AnalysisStep
...
class NetworkTab(QWidget):
    ...
    def _create_upload_section(self) -> QWidget:
        upload_frame = QFrame()
    ...
    def start_analysis(self):
        ...
        try:
            # Get analysis steps from analyzer
            self.analysis_steps = self.network_analyzer.analyze_network(self.network)
            ...
            self.file_label.setText(f"Analysis error: {str(e)}")
